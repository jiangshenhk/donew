...
function abcPositionSvg(abc) {
  ...
  const noteBoxBase = active === "A"
    ? { w: 208, h: 56, stroke: "#ff7a88", fill: "rgba(255,122,136,.08)" }
    : active === "B" || phase === "fail"
      ? { w: 206, h: 60, stroke: "#ffd166", fill: "rgba(255,209,102,.08)" }
      : { w: 208, h: 60, stroke: "#40d98a", fill: "rgba(64,217,138,.08)" };
