...
```
Barchart 期权链 → 筛选 DTE 3–25, Δ≈0.15 的 Put
       ↓
...
- 行权价 ≤ ATR安全行权价
- OTM ≥ 4%，Delta 绝对值 0.05–0.25，DTE 3–25天
- Bid ≥ 0.10、OI ≥ 50
- Bid/Ask 价差超过 Mid 的15% 只作为参考提示，不阻断开仓
- 允许同一标的重复开仓，但受最大持仓数和资金占用限制
...
v2.0.5 | 2026-08-07 | 放宽开仓标准：DTE 3–25 / 最大持仓 5 / 价差改参考 / 允许同标的多仓 / 回撤与连续亏损不阻断
